        ...
        styles: () => {
            ...
            const styles = `
                <style>
                    ...
                    .fg-emoji-nav {
                        background-color: var(--emoji_nav);
                    }
                    ...
                    .fg-picker-special-buttons a {
                        background-color: ${this.options.specialButtons ? this.options.specialButtons : 'var(--emoji_special_nav)'};
                    }
                    ...
                    .fg-emoji-list li a:hover {
                        background-color: var(--emoji_search_input);
                    }
